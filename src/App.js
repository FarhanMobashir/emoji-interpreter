...
function App() {
  ...
  useEffect(() => {
    inputValue.length === 0
      ? setMeaning("Waiting for your input")
      : db[inputValue] === undefined
      ? setMeaning("Oops! we don't have that in our db")
      ...
      <footer className="footer">
        <div className="footer-columns">
          ...
          <a
            ...
            href="https://github.com/FarhanMobashir/emoji-interpreter"
          >
            Source code
          </a>
          <a
            className="footer-link"
            href="https://www.youtube.com/watch?v=KUJsaM-hAjs&list=PLzvhQUIpvvuj5KPnyPyWsvgyzNkX_ACPA&index=7"
          >
